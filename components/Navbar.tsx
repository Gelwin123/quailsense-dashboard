...
export default function Navbar() {
  ...
  const [isClient, setIsClient] = useState(false); // Prevent hydration warning
  ...
  // Mark component as client only after mount
  useEffect(() => {
    setIsClient(true);
  }, []);
  ...
  return (
    <nav className="navbar">
      ...
      <style jsx>{`
        ...
        .link, .detector-link, .profile-btn {
          padding: 8px 16px;
          border-radius: 8px;
          font-weight: 600;
        ...
        .link:hover { background-color: #10b981; }
        .detector-link { background-color: #f59e0b; }
        .detector-link:hover { background-color: #fbbf24; }
        .profile-btn { background-color: #059669; }
        .profile-btn:hover { background-color: #10b981; }
        ...
        .desktop-dropdown .dropdown-item:hover { background-color: #dc2626; }
        ...
        .mobile-dropdown .detector-item { background-color: #f59e0b; }
        .mobile-dropdown .logout-btn { background-color: #ef4444; }
        .mobile-dropdown .dropdown-item:hover { opacity: 0.9; }
        .mobile-dropdown .detector-item:hover { background-color: #d97706; }
        .mobile-dropdown .logout-btn:hover { background-color: #dc2626; }
        ...
        @media (max-width: 768px) {
          .nav-links a, .profile-btn, .desktop-dropdown { display: none; }
